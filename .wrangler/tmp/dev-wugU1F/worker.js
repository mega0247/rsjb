  ...
  async fetch(request, env, ctx) {
    ...
    function generateRandomPrefixSuffix() {
      return {
        ...
        // 3-letter prefix (subdomain)
        suffix: generateRandomString(3)
        // 3-letter suffix (end of path)
      };
    }
    __name(generateRandomPrefixSuffix, "generateRandomPrefixSuffix");
    ...
    __name(generateRandomLinks, "generateRandomLinks");
    const url = new URL(request.url);
    const pathname = url.pathname;
    console.log("Pathname:", pathname);
    if (pathname === "/generate") {
      const randomLinks = generateRandomLinks(10);
...
// .wrangler/tmp/bundle-R9KwtO/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-R9KwtO/middleware-loader.entry.ts
